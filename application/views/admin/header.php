        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="index2.html" class="logo">
                    ...
                    <span class="logo-mini"><b>ALT</b></span> <!-- This logo is showed when the sidebar is collapsed -->
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b>A</b>dmin<b>LTE</b></span> <!-- This logo is showed when the sidebar is full with or in mobile view -->
                </a>
